...
C_SRCS += \
D:/yeoth/Projects/Frautos/Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.c 

OBJS += \
./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.o 

C_DEPS += \
./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.d 


# Each subdirectory must supply rules for building sources it contributes
Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.o: D:/yeoth/Projects/Frautos/Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.c Middleware/ThirdParty/SEGGER/OS/subdir.mk
...
clean: clean-Middleware-2f-ThirdParty-2f-SEGGER-2f-OS

clean-Middleware-2f-ThirdParty-2f-SEGGER-2f-OS:
	-$(RM) ./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.cyclo ./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.d ./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.o ./Middleware/ThirdParty/SEGGER/OS/SEGGER_SYSVIEW_FreeRTOS.su

.PHONY: clean-Middleware-2f-ThirdParty-2f-SEGGER-2f-OS
