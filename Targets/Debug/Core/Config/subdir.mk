...
C_SRCS += \
../Core/Config/Os_Cfg.c 

OBJS += \
./Core/Config/Os_Cfg.o 

C_DEPS += \
./Core/Config/Os_Cfg.d 
...
clean-Core-2f-Config:
	-$(RM) ./Core/Config/Os_Cfg.cyclo ./Core/Config/Os_Cfg.d ./Core/Config/Os_Cfg.o ./Core/Config/Os_Cfg.su
